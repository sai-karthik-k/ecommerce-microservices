    ...
    public SecurityWebFilterChain securityWebFilterChain(ServerHttpSecurity http) {
        http
            ...
            .authorizeExchange(exchanges -> exchanges
                ...
                .pathMatchers("/swagger-ui/**", "/v3/api-docs/**").permitAll()  // Optionally permit Swagger UI and API docs
                .anyExchange().authenticated()  // Require auth for all other requests (e.g., POST/PUT/DELETE)
            )
